...
if ($funcion == 'crear_administrador') {
    ...
    ob_start();
    $administrador->crear($nombre, $apellidos, $fecha_nacimiento, $cedula, $telefono, $direccion, $correo, $sexo, $adicional, $password_hash, $tipo, $avatar);
    $resultado = ob_get_clean();
    $resultado = trim($resultado);
    
    if($resultado == 'add') {
        echo json_encode(['success' => true, 'message' => 'Cuenta de administrador creada exitosamente']);
    } else if($resultado == 'existe') {
        echo json_encode(['success' => false, 'message' => 'Ya existe un administrador con esta cédula o correo']);
    } else {
