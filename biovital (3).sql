...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2026 a las 20:25:28
...
CREATE TABLE `consultorios` (
  ...
  `apertura_habitual` time DEFAULT '08:00:00',
  `cierre_habitual` time DEFAULT '17:00:00',
  ...
  `direccion_detallada` text DEFAULT NULL,
...
INSERT INTO `consultorios` (`id_consultorio`, `nombre`, `descripcion`, `apertura_habitual`, `cierre_habitual`, `telefono`, `email`, `estado`, `id_estado`, `ciudad`, `id_ciudad`, `municipio`, `id_municipio`, `parroquia`, `id_parroquia`, `direccion_detallada`, `latitud`, `longitud`, `activo`, `created_at`, `updated_at`) VALUES
(1, 'Centro Pediátrico Infantil', 'Especializado en niños', '08:00:00', '16:00:00', '(0212) 555-1122', 'pediatria@centro.com', 'Distrito Capital', NULL, 'Caracas', NULL, 'Libertador', NULL, 'San Bernardino', NULL, 'San Bernardino, Av. Panteón', NULL, NULL, 1, '2026-05-10 23:50:23', '2026-05-10 23:50:23'),
(2, 'rolando', 'matasano', '08:00:00', '11:05:00', '7878787878', 'roderichang0@gmail.com', 'Falcón', 10, 'Judibana', 161, 'Mauroa', 117, 'Casigua', 385, 'av . Barrio aguro', NULL, NULL, 1, '2026-05-11 12:55:16', '2026-05-11 12:55:16'),
(3, 'Centro abuelos Buen vivir', 'cuidados de adulto mayor', '08:00:00', '18:01:00', '8765456789', 'roderichanganibal@gmail.com', 'Apure', 3, 'Bruzual', 45, 'Muñóz', 31, 'Mantecal', 89, 'cerca del siete rojo', NULL, NULL, 1, '2026-05-12 14:57:18', '2026-05-12 14:57:18');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `consultorio_especialidades`
--
...
--
-- Volcado de datos para la tabla `consultorio_especialidades`
--

INSERT INTO `consultorio_especialidades` (`id`, `id_consultorio`, `especialidad`) VALUES
(1, 2, 'Pediatría'),
(2, 2, 'Nefrología'),
(3, 3, 'Cardiología'),
(4, 3, 'Oftalmología');
...
--
-- Estructura de tabla para la tabla `consultorio_horarios`
--
...
--
-- Estructura de tabla para la tabla `consultorio_medicos`
--
...
--
-- Estructura de tabla para la tabla `diagnostico_rec`
--

CREATE TABLE `diagnostico_rec` (
  `id_diagnostico` int(11) NOT NULL,
  `id_receta` int(11) NOT NULL,
  `diagnostico` text NOT NULL,
  `trat_sugerido` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `especialidades` (`id_especialidad`, `nombre`, `descripcion`, `costo_base`) VALUES
(1, 'Medicina General', 'Atención médica general y primer contacto', 500.00),
(2, 'Cardiología', 'Especialidad en enfermedades del corazón', 800.00),
(3, 'Pediatría', 'Atención médica de niños y adolescentes', 700.00),
(4, 'Dermatología', 'Especialidad en enfermedades de la piel', 750.00),
(5, 'Ginecología', 'Salud femenina y sistema reproductivo', 800.00),
(6, 'Ortopedia', 'Enfermedades del sistema musculoesquelético', 750.00);
...
--
-- Estructura de tabla para la tabla `est_laboratorio`
--

CREATE TABLE `est_laboratorio` (
  `id_estudio` int(11) NOT NULL,
  `id_receta` int(11) NOT NULL,
  `est_solicitado` text NOT NULL,
  `obs_adicional` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `est_laboratorio`
--

INSERT INTO `est_laboratorio` (`id_estudio`, `id_receta`, `est_solicitado`, `obs_adicional`, `created_at`) VALUES
(1, 10, 'Placa de tórax, Examen de orina', 'diarrea cronica', '2026-04-25 21:23:33');
...
CREATE TABLE `login_administrador` (
  `id_login_administrador` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `login_asistente`
--

CREATE TABLE `login_asistente` (
  `id_login_asistente` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `login_medico`
--

CREATE TABLE `login_medico` (
  `id_login_medico` int(11) NOT NULL,
  `id_medico` int(11) NOT NULL,
  `password_hash` varchar(255) NOT NULL,
  `status` enum('activo','inactivo') DEFAULT 'activo',
  `ultimo_acceso` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `login_paciente` (
  `id_login_paciente` int(11) NOT NULL,
...
INSERT INTO `recetas` (`id_receta`, `nombre_medicamento`, `marca`, `cantidad`, `dosis`, `instrucciones`, `id_paciente`, `id_medico`, `fecha_receta`, `estado`, `created_at`, `updated_at`) VALUES
(4, 'para hacer el amor', 'siempreduro', '3', '8 horas', 'dormir 23 horas diarias por 365 dias prorrogable', 7, 5, '2026-04-24', 0, '2026-04-24 01:10:44', '2026-04-25 17:08:40'),
(5, 'metetelaenterona', 'golosina', '5 tajali', '1 cada 12 horas', 'Agrandesimiento en el duodeno', 1, 5, '2026-04-24', 1, '2026-04-24 01:14:29', '2026-04-24 01:14:29'),
(6, 'pingasilina', 'lorgon', '20 cm', 'cada 8 horas', '', 6, 5, '2026-04-24', 1, '2026-04-24 01:53:31', '2026-04-24 01:53:31'),
(7, 'omeprazol', 'genden', '10 pastillas', '500mg', 'tomar cada 12 horas 1 tableta', 8, 5, '2026-04-25', 1, '2026-04-25 14:42:53', '2026-04-25 14:42:53'),
(8, 'ESTUDIOS DE LABORATORIO', 'Solicitud de estudios', '1 solicitud', 'Realizar según indicaciones', 'ESTUDIOS SOLICITADOS:\n• Hemograma', 1, 5, '2026-04-25', 1, '2026-04-25 20:22:27', '2026-04-25 20:22:27'),
(9, 'DIAGNÓSTICO MÉDICO', 'Registro médico', '1 diagnóstico', 'Ver instrucciones', 'DIAGNÓSTICO:\ncancer terminal\n\nTRATAMIENTO SUGERIDO:\nbuscar funeraria lo antes posible', 1, 5, '2026-04-25', 1, '2026-04-25 20:25:18', '2026-04-25 20:25:18'),
(10, 'ESTUDIOS DE LABORATORIO', 'Solicitud de estudios', '2 estudio(s) solicitado(s)', 'Realizar según indicaciones', 'ESTUDIOS SOLICITADOS:\n• Placa de tórax\n• Examen de orina\n\nOBSERVACIONES:\ndiarrea cronica', 1, 5, '2026-04-25', 1, '2026-04-25 21:23:33', '2026-04-25 21:23:33'),
(11, 'para hacer el amor', 'siempreduro', '4', '1 cada 12 horas', 'dormir 23 horas al dia', 1, 2, '2026-05-04', 1, '2026-05-04 04:49:25', '2026-05-04 04:49:25');
...
CREATE TABLE `registro_administrador` (
  ...
  `cedula_administrador` varchar(25) NOT NULL,
  `telefono_administrador` varchar(20) DEFAULT NULL,
  `direccion_administrador` varchar(45) DEFAULT NULL,
  `correo_administrador` varchar(45) DEFAULT NULL,
  `sexo_administrador` varchar(25) DEFAULT NULL,
  `adicional_administrador` text DEFAULT NULL,
  `avatar_administrador` varchar(255) DEFAULT 'avatarDES.jpg',
  `administrador_tipo` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `registro_asistente`
--

CREATE TABLE `registro_asistente` (
  `id_asistente` int(11) NOT NULL,
  `nombre_asistente` varchar(45) NOT NULL,
  `apellido_asistente` varchar(45) NOT NULL,
  `fecha_nacimiento_asistente` date NOT NULL,
  `cedula_asistente` varchar(25) NOT NULL,
  `telefono_asistente` varchar(20) DEFAULT NULL,
  `direccion_asistente` varchar(45) DEFAULT NULL,
  `correo_asistente` varchar(45) DEFAULT NULL,
  `sexo_asistente` varchar(25) DEFAULT NULL,
  `adicional_asistente` text DEFAULT NULL,
  `avatar_asistente` varchar(255) DEFAULT 'avatarDES.jpg',
  `asistente_tipo` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `registro_medico` (
  ...
  `cedula_medico` varchar(25) NOT NULL,
  `telefono_medico` varchar(20) DEFAULT NULL,
  `direccion_medico` varchar(45) DEFAULT NULL,
  `correo_medico` varchar(45) DEFAULT NULL,
  `sexo_medico` varchar(25) DEFAULT NULL,
  `adicional_medico` text DEFAULT NULL,
  `avatar_medico` varchar(255) DEFAULT 'avatarDES.jpg',
...
CREATE TABLE `registro_paciente` (
  ...
  `cedula_paciente` varchar(25) NOT NULL,
  `telefono_paciente` varchar(20) DEFAULT NULL,
  `direccion_paciente` varchar(45) DEFAULT NULL,
  `correo_paciente` varchar(45) DEFAULT NULL,
  `sexo_paciente` varchar(25) DEFAULT NULL,
  `adicional_paciente` text DEFAULT NULL,
  `avatar_paciente` varchar(255) DEFAULT 'avatarDES.jpg',
  `paciente_tipo` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `registro_paciente` (`id_paciente`, `nombre_paciente`, `apellido_paciente`, `fecha_nacimiento_pac`, `cedula_paciente`, `telefono_paciente`, `direccion_paciente`, `correo_paciente`, `sexo_paciente`, `adicional_paciente`, `avatar_paciente`, `paciente_tipo`, `created_at`, `updated_at`) VALUES
(1, 'Maria', 'Angustia', '2026-05-19', '1', '04125873409', 'el garrotal', 'roderichang1@gmail.com', 'masculino', 'tulucutudtu', 'avatarDES.jpg', 1, '2026-05-15 18:20:01', '2026-05-15 18:20:01');
...
INSERT INTO `sedes` (`id_sede`, `nombre`, `direccion`, `telefono`, `email`, `activo`) VALUES
(1, 'Sede Centro', 'Av. Central 123, Ciudad Centro', '555-0101', 'centro@clinica.com', 1),
(2, 'Sede Norte', 'Calle Norte 456, Zona Norte', '555-0102', 'norte@clinica.com', 1),
(3, 'Sede Sur', 'Av. Sur 789, Zona Sur', '555-0103', 'sur@clinica.com', 1);
...
INSERT INTO `tipo_paciente` (`id_tipo_us`, `nombre_tipo`) VALUES
(1, 'Paciente'),
(2, 'Medico'),
(3, 'Paciente'),
(4, 'Médico'),
...
ALTER TABLE `consultorios`
  ...
  ADD KEY `idx_ciudad` (`id_ciudad`),
  ADD KEY `idx_municipio` (`id_municipio`),
  ADD KEY `idx_parroquia` (`id_parroquia`);

--
-- Indices de la tabla `consultorio_especialidades`
--
ALTER TABLE `consultorio_especialidades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_consultorio` (`id_consultorio`);

--
-- Indices de la tabla `consultorio_horarios`
--
ALTER TABLE `consultorio_horarios`
  ADD PRIMARY KEY (`id_horario`),
  ADD KEY `id_consultorio` (`id_consultorio`),
  ADD KEY `id_medico` (`id_medico`);

--
-- Indices de la tabla `consultorio_medicos`
--
ALTER TABLE `consultorio_medicos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_consultorio` (`id_consultorio`),
  ADD KEY `id_medico` (`id_medico`);

--
-- Indices de la tabla `diagnostico_rec`
--
ALTER TABLE `diagnostico_rec`
  ADD PRIMARY KEY (`id_diagnostico`),
  ADD KEY `id_receta` (`id_receta`);

--
-- Indices de la tabla `est_laboratorio`
--
ALTER TABLE `est_laboratorio`
  ADD PRIMARY KEY (`id_estudio`),
  ADD KEY `id_receta` (`id_receta`);

--
-- Indices de la tabla `login_administrador`
--
ALTER TABLE `login_administrador`
  ADD PRIMARY KEY (`id_login_administrador`),
  ADD KEY `id_administrador` (`id_administrador`);

--
-- Indices de la tabla `login_asistente`
--
ALTER TABLE `login_asistente`
  ADD PRIMARY KEY (`id_login_asistente`),
  ADD KEY `id_asistente` (`id_asistente`);

--
-- Indices de la tabla `login_medico`
--
ALTER TABLE `login_medico`
  ADD PRIMARY KEY (`id_login_medico`),
  ADD KEY `id_medico` (`id_medico`);
...
ALTER TABLE `login_paciente`
  ADD PRIMARY KEY (`id_login_paciente`),
...
ALTER TABLE `registro_administrador`
  ...
  ADD UNIQUE KEY `cedula_administrador` (`cedula_administrador`),
  ADD KEY `administrador_tipo` (`administrador_tipo`);

--
-- Indices de la tabla `registro_asistente`
--
ALTER TABLE `registro_asistente`
  ADD PRIMARY KEY (`id_asistente`),
  ADD UNIQUE KEY `cedula_asistente` (`cedula_asistente`),
  ADD KEY `asistente_tipo` (`asistente_tipo`);
...
ALTER TABLE `registro_medico`
  ...
  ADD UNIQUE KEY `cedula_medico` (`cedula_medico`),
  ADD KEY `medico_tipo` (`medico_tipo`);
...
ALTER TABLE `registro_paciente`
  ...
  ADD KEY `paciente_tipo` (`paciente_tipo`);
...
--
-- AUTO_INCREMENT de la tabla `consultorio_especialidades`
--
ALTER TABLE `consultorio_especialidades`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `consultorio_horarios`
--
ALTER TABLE `consultorio_horarios`
  MODIFY `id_horario` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `consultorio_medicos`
--
ALTER TABLE `consultorio_medicos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `diagnostico_rec`
--
ALTER TABLE `diagnostico_rec`
  MODIFY `id_diagnostico` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `est_laboratorio`
--
ALTER TABLE `est_laboratorio`
  MODIFY `id_estudio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `login_administrador`
--
ALTER TABLE `login_administrador`
  MODIFY `id_login_administrador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `login_asistente`
--
ALTER TABLE `login_asistente`
  MODIFY `id_login_asistente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `login_medico`
--
ALTER TABLE `login_medico`
  MODIFY `id_login_medico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `login_paciente`
--
ALTER TABLE `login_paciente`
  MODIFY `id_login_paciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `recetas`
--
ALTER TABLE `recetas`
  MODIFY `id_receta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT de la tabla `registro_asistente`
--
ALTER TABLE `registro_asistente`
  MODIFY `id_asistente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tipo_paciente`
  MODIFY `id_tipo_us` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Filtros para la tabla `consultorio_especialidades`
--
ALTER TABLE `consultorio_especialidades`
  ADD CONSTRAINT `consultorio_especialidades_ibfk_1` FOREIGN KEY (`id_consultorio`) REFERENCES `consultorios` (`id_consultorio`) ON DELETE CASCADE;

--
-- Filtros para la tabla `consultorio_horarios`
--
ALTER TABLE `consultorio_horarios`
  ADD CONSTRAINT `consultorio_horarios_ibfk_1` FOREIGN KEY (`id_consultorio`) REFERENCES `consultorios` (`id_consultorio`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultorio_horarios_ibfk_2` FOREIGN KEY (`id_medico`) REFERENCES `registro_medico` (`id_medico`) ON DELETE SET NULL;

--
-- Filtros para la tabla `consultorio_medicos`
--
ALTER TABLE `consultorio_medicos`
  ADD CONSTRAINT `consultorio_medicos_ibfk_1` FOREIGN KEY (`id_consultorio`) REFERENCES `consultorios` (`id_consultorio`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultorio_medicos_ibfk_2` FOREIGN KEY (`id_medico`) REFERENCES `registro_medico` (`id_medico`) ON DELETE CASCADE;

--
-- Filtros para la tabla `diagnostico_rec`
--
ALTER TABLE `diagnostico_rec`
  ADD CONSTRAINT `diagnostico_rec_ibfk_1` FOREIGN KEY (`id_receta`) REFERENCES `recetas` (`id_receta`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `est_laboratorio`
--
ALTER TABLE `est_laboratorio`
  ADD CONSTRAINT `est_laboratorio_ibfk_1` FOREIGN KEY (`id_receta`) REFERENCES `recetas` (`id_receta`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `login_administrador`
--
ALTER TABLE `login_administrador`
  ADD CONSTRAINT `login_administrador_ibfk_1` FOREIGN KEY (`id_administrador`) REFERENCES `registro_administrador` (`id_administrador`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `login_asistente`
--
ALTER TABLE `login_asistente`
  ADD CONSTRAINT `login_asistente_ibfk_1` FOREIGN KEY (`id_asistente`) REFERENCES `registro_asistente` (`id_asistente`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `login_medico`
--
ALTER TABLE `login_medico`
  ADD CONSTRAINT `login_medico_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `registro_medico` (`id_medico`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `login_paciente`
--
ALTER TABLE `login_paciente`
  ADD CONSTRAINT `login_paciente_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `registro_paciente` (`id_paciente`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `registro_administrador`
--
ALTER TABLE `registro_administrador`
  ADD CONSTRAINT `registro_administrador_ibfk_1` FOREIGN KEY (`administrador_tipo`) REFERENCES `tipo_paciente` (`id_tipo_us`);

--
-- Filtros para la tabla `registro_asistente`
--
ALTER TABLE `registro_asistente`
  ADD CONSTRAINT `registro_asistente_ibfk_1` FOREIGN KEY (`asistente_tipo`) REFERENCES `tipo_paciente` (`id_tipo_us`);

--
-- Filtros para la tabla `registro_medico`
--
ALTER TABLE `registro_medico`
  ADD CONSTRAINT `registro_medico_ibfk_1` FOREIGN KEY (`medico_tipo`) REFERENCES `tipo_paciente` (`id_tipo_us`);

--
-- Filtros para la tabla `registro_paciente`
--
ALTER TABLE `registro_paciente`
  ADD CONSTRAINT `registro_paciente_ibfk_1` FOREIGN KEY (`paciente_tipo`) REFERENCES `tipo_paciente` (`id_tipo_us`);
COMMIT;
