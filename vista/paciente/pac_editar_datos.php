...
<script>
// Corrección para el botón de edición (el selector estaba mal)
$(document).ready(function() {
    // Corregir el selector del botón editar
    $('.btn-editor').addClass('edit');
    
    // También asegurar que el botón con clase 'edit' funcione
    $(document).on('click', '.edit', function(e) {
        e.preventDefault();
        console.log('Botón editar clickeado');
        // Esto llamará a la función en paciente.js
    });
});
</script>
