...
<head>
    ...
    <title>Paciente | Editar datos</title>
    <style>
                    ...
                    <div class="col-md-3">
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <input id="id_usuario" type="hidden" value="<?php echo htmlspecialchars($id_paciente); ?>">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>Tipo Usuario</b>
                                        <span id="us_tipo" class="float-right badge badge-primary">Paciente</span>
                                    </li>
                            ...
                            <div class="card-body">
                                ...
                                <form id="form-usuario" class="form-horizontal" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="adicional" rows="5" placeholder="Información adicional sobre el paciente..." disabled></textarea>
                                        </div>
                                    </div>
