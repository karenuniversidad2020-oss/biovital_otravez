...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <a href="<?php echo APP_URL; ?>/logout" class="btn btn-danger btn-sm"><i class="fas fa-sign-out-alt"></i> Cerrar sesión</a>
    </ul>
</nav>
            ...
            <div class="row">
                <div class="col-lg-4 col-6">
                    <div class="small-box bg-info bv-animate bv-animate-delay-1">
                        ...
                        <a href="<?php echo APP_URL; ?>/paciente/recetas" class="small-box-footer">Ver recetas <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
