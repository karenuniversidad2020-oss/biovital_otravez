...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="../medico/med_catalogo.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
            <a href="../../vista/medico/med_editar_datos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../../vista/medico/adm_recetas.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../../vista/medico/med_pacientes.php" class="nav-link">
