...
<body>
            ...
            <div class="carousel-wrapper">
                <div class="carousel-track">
                    <div class="carousel-slide">
                        <img src="<?php echo APP_URL; ?>/img/banner.jpeg" alt="Instalaciones Modernas" class="carousel-img">
                    ...
                    <div class="carousel-slide">
                        <img src="<?php echo APP_URL; ?>/img/Doctoraaaa.jpeg" alt="Equipo Médico" class="carousel-img">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-slide">
                        <img src="<?php echo APP_URL; ?>/img/locacion.jpeg" alt="Atención Personalizada" class="carousel-img">
                        <div class="carousel-caption">
                ...
                <button class="carousel-btn carousel-btn-prev" id="prevBtn" aria-label="Anterior">
                    <i class="fas fa-chevron-left"></i>
                </button>
                <button class="carousel-btn carousel-btn-next" id="nextBtn" aria-label="Siguiente">
    ...
    <section class="about" id="nosotros">
        <div class="about-container">
            <div class="about-image">
                <img src="<?php echo APP_URL; ?>/img/Doctoraaaa.jpeg" alt="Profesional de la salud" class="about-img">
            ...
            <div class="about-content">
                ...
                <p class="about-text">
                    En BioVital, nos comprometemos a ofrecer servicios médicos de la más alta calidad con un equipo de profesionales altamente calificados y experimentados. Nuestra misión es brindar atención médica integral y personalizada.
                </p>
                <p class="about-text">
                    Contamos con tecnología de última generación e instalaciones modernas para asegurar diagnósticos precisos y tratamientos efectivos en todas nuestras especialidades.
                </p>
    ...
    <section class="contact" id="contacto">
        <div class="contact-container">
            <div class="section-header">
                <span class="section-tag"><i class="fas fa-headset"></i> Comunícate</span>
                <h2 class="section-title">¿Tienes alguna <span class="gradient-text">Pregunta?</span></h2>
            </div>
                ...
                <div class="contact-form-card">
                    <form class="contact-form" id="contactForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="contactEmail" placeholder="tu@email.com" required>
                        </div>
                        <div class="form-group">
                            <label for="contactMessage">Mensaje</label>
                            <textarea id="contactMessage" rows="4" placeholder="¿En qué podemos ayudarte?" required></textarea>
                        </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 BioVital. Todos los derechos reservados. Plataforma Tecnológica Hospitalaria.</p>
            </div>
        </div>
    </footer>
    ...
    <div class="modal" id="specialtyModal">
        <div class="modal-content">
            <span class="close-modal" onclick="closeSpecialtyModal()">&times;</span>
