...
<head>
    ...
    <title>Login Medico - BioVital</title>
...
// Solo verificar si ya está logueado
        ...
        <div class="contenido-login">
            <form id="form-login" method="POST">
                ...
                <div class="text-center mt-3">
                    <a href="<?php echo APP_URL; ?>/registro/medico" class="btn btn-link" style="text-decoration: none;">Crear nueva cuenta</a>
                </div>
