...
<head>
    ...
    <title>Login Asistente - BioVital</title>
        ...
        <div class="contenido-login">
            <form id="form-login" method="POST">
                ...
                <div class="text-center mt-3">
                    <a href="<?php echo APP_URL; ?>/registro/asistente" class="btn btn-link" style="text-decoration: none;">Crear nueva cuenta</a>
                </div>
